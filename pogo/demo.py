...
def findPokemons(session, seen={}):
    ...
    for cell in cells.map_cells:
        ...
        for pokemon in cell.wild_pokemons:
            if not pokemon.encounter_id in seen:
                seen[pokemon.encounter_id] = {
                    'id': pokemon.pokemon_data.pokemon_id,
                    'latitude': pokemon.latitude,
                    'longitude': pokemon.longitude,
                    'expire_time': cell.current_timestamp_ms + pokemon.time_till_hidden_ms,
        ...
        for pokemon in cell.catchable_pokemons:
            if not pokemon.encounter_id in seen:
                seen[pokemon.encounter_id] = {
                    ...
                    'latitude': pokemon.latitude,
                    'longitude': pokemon.longitude,
                    'expire_time': pokemon.expiration_timestamp_ms,
                    'encounter_id': pokemon.encounter_id
                }
            ...
            #logging.info("%s, %f meters away at (%f, %f)" % (
                #pokedex[pokemonId],
                #dist,
                #pokemon.latitude,
                #pokemon.longitude
...
if __name__ == '__main__':
    ...
    if session:
        ...
        if args.location:
            ...
            print('{}'.format(json.dumps(pokemons, indent=2)))
